...
namespace Proyecto_Unidad_1_Programacion_Visual
{
    ...
    {
        // Método para insertar un nuevo coche (ALTA)
        ...
        // Método para consultar un coche por placa (CONSULTAR)
        ...
        // Método para actualizar un coche (CAMBIOS)
        ...
        // Método para eliminar un coche (BAJA)
